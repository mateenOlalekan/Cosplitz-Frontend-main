...
/* Loader (must NOT be lazy) */
import LoadingFallback from "./components/Other/LoadingFallback";
...
const Successful = lazy(() =>
  import("./pages/Dashboard/SplitzSuccessful")
);
const Wallet = lazy(() => import("./pages/Dashboard/Wallet"));
const CreateSplitzPage = lazy(() =>
  import("./pages/Dashboard/CreateSplitz")
);
const NotificationPage = lazy(() =>
  import("./pages/Dashboard/Notification")
);
const MySplitz = lazy(() => import("./pages/Dashboard/MySplitz"));
const SplitzDetail = lazy(() =>
  import("./pages/Dashboard/SplitDetailPage")
);
const AllSplitsPage = lazy(() =>
  import("./pages/Dashboard/AllSplitsPage")
);
const MySplitsPage = lazy(() =>
  import("./pages/Dashboard/MySplitsPage")
);
